            ...
            <form action="" method="post">
                <div class="flex flex-col gap-4">
                    <div class="flex flex-col gap-2">
                        ...
                        <input type="text" id="judul" value="<?= $data['judul'] ?>" name="judul" class="border border-stone-200 rounded-lg px-3 py-2 text-sm text-stone-900 focus:outline-none focus:border-amber-500 transition-colors" placeholder="Masukkan judul">
                    </div>
                    <div class="flex flex-col gap-2">
