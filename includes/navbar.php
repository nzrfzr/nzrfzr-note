...
$path_prefix = "";
if (basename(dirname($_SERVER['SCRIPT_NAME'])) == 'pages' || basename(dirname($_SERVER['SCRIPT_NAME'])) == 'function') {
    $path_prefix = "../";
}
?>
<nav class="bg-white border-b border-stone-200 sticky top-0 z-40">
  <div class="max-w-5xl mx-auto px-4 sm:px-6 flex items-center justify-between h-14 ">
    <a href="<?= $path_prefix ?>index.php" class="text-lg font-semibold tracking-tight flex items-center gap-2">
    ...
    <div class="flex items-center gap-4">
      ...
      <a href="<?= $path_prefix ?>function/logout.php"
